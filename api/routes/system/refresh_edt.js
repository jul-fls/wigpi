...
router.get('/', (req, res) => {
    ...
    const lockFilePath = path.join(paths.output.lock, 'refresh.lock');
    ...
    setImmediate(async () => {
        ...
        const restoreConsole = redirectLogsToFile(path.join(paths.logs, 'create_ics.log'));
